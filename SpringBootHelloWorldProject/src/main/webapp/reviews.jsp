...
<body>
    ...
    <div class="container">
        <div class="vehicle">
            <h2>Kia Sonet</h2>
    <a href="photo1.html"> <img src="vehicle1.png" alt="Kia Sonet Image" style="max-width: 100%; height: auto;"></a>
            ...
            <p class="vehicle-price">Price: $30,000</p>
        ...
        <div class="vehicle">
          ...
          <a href="photo2.html">  <img src="vehicle2.png" alt="image not found" style="max-width: 100%; height: 60%;"></a>
            <div class="vehicle-rating">
                Rating:
                <span class="star">&#9733;</span>
                <span class="star">&#9733;</span>
            ...
            <p class="vehicle-price">Price: $25,000</p>
        ...
        <div class="vehicle">
            <h2>Mahindra Thar</h2>
            <a href="photo3.html"><img src="vehicle3.png" alt="image not found" style="max-width: 100%; height: auto;"></a>
            <div class="vehicle-rating">
                Rating:
                <span class="star">&#9733;</span>
                <span class="star">&#9733;</span>
            ...
            <p class="vehicle-price">Price: $35,000</p>
        ...
        <div class="vehicle">
            ...
            <p class="vehicle-price">Price: $22,000</p>
            <p class="vehicle-review">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
             <center><a href="book" class="learn-more-button">Book your vehicle</a></center> 
        </div>
        ...
        <div class="vehicle">
           ...
           <a href="photo5.html" ><img src="vehicle5.png" alt="image not found" style="max-width: 100%; height: auto;"></a>
            ...
            <p class="vehicle-price">Price: $45,000</p>
            <p class="vehicle-review">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
             <center><a href="book" class="learn-more-button">Book your vehicle</a></center>
        </div>
        ...
        <div class="vehicle">
           ...
           <a href="photo6.html"> <img src="vehicle6.png" alt="image not found" style="max-width: 100%; height: auto;"></a>
            ...
            <p class="vehicle-price">Price: $85,000</p>
            <p class="vehicle-review">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
             <center><a href="book" class="learn-more-button">Book your vehicle</a></center>
        </div>
